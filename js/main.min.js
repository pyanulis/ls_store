var Accordeon=function(){function t(t){var e=t.closest(".filter__item"),i=e.find(".filter__content"),n=t.closest(".filter").find(".filter__content");e.hasClass("active")?(e.removeClass("active"),i.stop(!0,!0).slideUp()):(n.slideUp().closest(".filter__item").removeClass("active"),e.addClass("active"),i.stop(!0,!0).slideDown())}return{init:function(){$(".filter__title-link").on("click",function(e){e.preventDefault();var i=$(this);t(i)})}}}();
$(document).ready(function(){ViewWidget.init(),Slideshow.init(),Accordeon.init(),$(".products__rating").length&&RatingWidget.init();var e=$(".sort__select-elem");e.length&&e.select2({minimumResultsForSearch:1/0}),$(".filter__slider-element").length&&SliderWidget.init(),$(".filter__reset").on("click",function(e){e.preventDefault();var t=$(this),i=t.closest(".filter__item"),n=i.find("input:checkbox");n.each(function(){$(this).removeProp("checked")})}),$(".attention__text").columnize({width:500})});
var RatingWidget=function(){function t(t){for(var r=[],a=0;5>a;++a){var n="products__rating-stars-item";t>a&&(n+=" products__rating-stars-item_filled");var i=$("<li>",{"class":n});r.push(i)}return r}function r(r,a){var n=$("<ul>",{"class":"products__rating-stars",html:t(r)}),i=$("<div>",{"class":"products__rating-amount",text:r});a.append([n,i])}return{init:function(){$(".products__rating").each(function(){var t=$(this),a=parseInt(t.data("rating"));r(a,t)})}}}();
var SliderWidget=function(){function i(i){var e=i.closest(".filter__slider"),n=e.find(".filter__slider-input_from"),t=e.find(".filter__slider-input_to"),r=i.slider("option","values");n.val(r[0]),t.val(r[1])}return{init:function(){$(".filter__slider-element").each(function(){var e=$(this),n=parseInt(e.data("slider-min")),t=parseInt(e.data("slider-max"));e.slider({range:!0,min:n,max:t,values:[n,t],slide:function(){i(e)},create:function(){i(e)}})})}}}();
var Slideshow=function(){function s(s){var i=s.closest(".products__slideshow"),t=s.find("img").attr("src"),e=i.find(".products__slideshow-img");s.closest(".products__slideshow-item").addClass("active").siblings().removeClass("active"),e.fadeOut(200,function(){$(this).attr("src",t).fadeIn(200)})}function i(s){s.closest(".filter__colors-item").addClass("active").siblings().removeClass("active")}return{init:function(){$(".products__slideshow-link").on("click",function(i){i.preventDefault();var t=$(this);s(t)}),$(".filter__colors-item").on("click",function(s){s.preventDefault();var t=$(this);i(t)})}}}();
var ViewWidget=function(){function t(t){var n=t.closest(e),a=n.data("view"),c=$(".products__list"),o="products__list_",r=o+a;""==s&&(s=c.attr("class")),i(t),c.attr("class",s+" "+r)}function i(t){t.closest(e).addClass("active").siblings().removeClass("active")}var s="",e=".sort__view-item";return{init:function(){$(".sort__view-link").on("click",function(i){i.preventDefault(),t($(this))})}}}();
